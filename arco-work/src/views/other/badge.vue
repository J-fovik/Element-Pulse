<template>
  <div>
    <a-row :gutter="[10, 10]">
      <a-col :span="12">
        <a-card title="警告信息alert" :body-style="{ padding: '10px' }" :header-style="{ padding: '10px' }">
      ...
      <a-col :span="12">
        <a-card title="对话框Dialog" :body-style="{ padding: '10px' }" :header-style="{ padding: '10px' }">
          <div class="padding">
            <a-space>
        ...
        <br />
        <a-card title="信息Message" :body-style="{ padding: '10px' }" :header-style="{ padding: '10px' }">
          <a-space>
        ...
        <br />
        <a-card title="通知Notification" :content-style="{ padding: '10px' }" :header-style="{ padding: '10px' }">
          <a-space>
