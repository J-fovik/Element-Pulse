<template>
	<div>
		<el-alert class="mb10" title="使用方式：v-lazy='imgUrl'" type="success" :closable="false" />
				...
				<el-row :gutter="20">
					...
					>
						<div class="flx-center flex-col">
							<img v-lazy="item.img" style="width: 300px; height: 250px" />
							<div class="mt20">{{ item.title }}</div>
						</div>
					</el-col>
				</el-row>
			</div>
