<template>
	<Container>
		...
		<el-divider content-position="left"> 使用 v-auths 指令绑定多个权限 </el-divider>
		<el-row>
			<el-button
				v-auths="['add', 'edit', 'delete', 'import', 'export']"
				type="primary"
				:icon="CirclePlus"
			>
				新增
		...
		<el-divider content-position="left"> 使用 v-auth-all 指令绑定多个权限 </el-divider>
		<el-row>
			<el-button
				v-auth-all="['add', 'edit', 'delete', 'import', 'export']"
				type="primary"
				:icon="CirclePlus"
			>
				新增
