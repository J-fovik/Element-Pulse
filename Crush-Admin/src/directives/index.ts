...
import { authDirective } from '@/directives/modules/authDirective';
import {
	wavesDirective,
	fadeUpDirective,
	lazyImgDirective,
...
} from '@/directives/modules/customDirective';
import {
	dragDirective,
	throttleDirective,
	debounceDirective,
	...
	copyDirective,
	scrollToDirective,
} from '@/directives/modules/operateDirective';
 ...
 * @methods dragDirective 父元素内拖动指令 ，用法：v-drag
