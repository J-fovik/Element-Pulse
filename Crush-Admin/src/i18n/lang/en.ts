...
export default {
	router: {
		...
		visualizationBaidu: 'baidu',
		visualizationGaode: 'gaode',
		visualizationMapEcharts: 'EchartsMap',
		visualizationChartEcharts: 'chart Echarts',
		visualizationWangEditor: 'wangEditor',
		personal: 'personal',
	...
	noAccess: {
		...
		accessMsg: 'Please change your login account',
