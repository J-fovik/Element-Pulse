<template>
	<el-dialog
		:model-value="true"
		:title="form.postId ? (form.isReadOnly ? '岗位详情' : '编辑岗位') : '新增岗位'"
		width="60vw"
		draggable
			...
			<el-row :gutter="24">
				...
				<el-col :span="12">
					<el-form-item label="岗位编码" prop="postCode">
						<el-input v-model.trim="form.postCode" placeholder="请输入岗位编码" />
					</el-form-item>
				</el-col>
				<el-col :span="12">
...
const validateData = (formEl: any) => {
	...
	formEl.validate((valid) => {
		if (valid) {
			/* 可加其他特殊校验 */
			/* 有id则表示修改，没有则表示新增 */
			if (props.data.postId) submitData('editApi');
