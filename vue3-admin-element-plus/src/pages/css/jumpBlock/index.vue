<template>
  <div class="content rounded bg-white" style="height: calc(100vh - 144px);overflow: auto;;">
    <ul class="icon-list">
      <li class="icon-list__item">
        <a href="https://twitter.com/alphardex007" target="_blank">
          <div class="box">
            <div class="box__face box__face--front">
              <svg t="1580194450242" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="9911" width="40" height="40">
                <path
      ...
      <li class="icon-list__item">
        <a href="https://codepen.io/alphardex" target="_blank">
          <div class="box">
            <div class="box__face box__face--front">
              <svg t="1580194836809" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="10289" width="40" height="40">
                <path
      ...
      <li class="icon-list__item">
        <a href="https://github.com/alphardex" target="_blank">
          <div class="box">
            <div class="box__face box__face--front">
              <svg t="1580194880319" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="10619" width="40" height="40">
                <path
      ...
      <li class="icon-list__item">
        <a href="https://www.linkedin.com/in/nameless-god-60970313a" target="_blank">
          <div class="box">
            <div class="box__face box__face--front">
              <svg t="1580194916849" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="10901" width="40" height="40">
                <path
      ...
      <li class="icon-list__item">
        <a href="https://www.instagram.com/mumei_ouja" target="_blank">
          <div class="box">
            <div class="box__face box__face--front">
              <svg t="1580194981209" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="11741" width="40" height="40">
                <path
